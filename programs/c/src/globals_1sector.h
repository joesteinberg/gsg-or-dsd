...
#define NS 3 // still need this to set up the IO data
#define NC 2
#define NF 2
#define NT 100
#define NMATCH 17
...
static inline void fprintf_mat_1(FILE * file, const double mat[][NS], uint n)
{
  uint i,j;
  for(i=0; i<n; i++)
    {
...
static inline void fprintf_mat_2(FILE * file, const double mat[][NS-1], uint n)
{
  uint i,j;
  for(i=0; i<n; i++)
    {
...
static inline void fprintf_mat_3(FILE * file, const double mat[][NC], uint n)
{
  uint i,j;
  for(i=0; i<n; i++)
    {
